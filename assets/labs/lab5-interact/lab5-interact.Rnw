...
\section*{Lab 5: Modeling predictors of lung health}
...
\begin{exercise}
Based on your work above, pick one model that represents what you think is the ``best'' model for this data. Justify your choice, and interpret what you think are the most important or interesting relationships with the covariates and FEV.  Illustrate one of these relationships with a figure.
\end{exercise}
